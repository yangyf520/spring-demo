...
public final class NumberUtils {
     ...
     * formatString: #,###0.00
     */
    public static final String DECIMAL_FORMAT_N2 = ConstantUtils.getConstantValue("#,##0.00");

    /**
     * formatString: #,###0.00##
     */
    public static final String DECIMAL_FORMAT_N4 = ConstantUtils.getConstantValue("#,##0.0000");

    /**
     * 精度：2
     */
    public static final String FORMAT_TYPE_N2 = ConstantUtils.getConstantValue("n2");
    ...
    public static double div(double v1, double v2) {
        return new BigDecimal(v1).divide(new BigDecimal(v2), BigDecimal.ROUND_HALF_UP).doubleValue();
    }
