...
public final class HtmlRegexpUtil {
    // 过滤所有以<开头以>结尾的标签
    private final static String REG_EX_FOR_HTML = "<([^>]*)>";
    ...
    public static String filterHtml(String str) {
        Pattern pattern = Pattern.compile(REG_EX_FOR_HTML);
    ...
    public static String replaceHtmlTag(String str, String beforeTag, String tagAttr, String startTag, String endTag) {
        ...
        String regExForTagAttr = tagAttr + "=\"([^\"]+)\"";
        Pattern patternForTag = Pattern.compile(regExForTag);
        Pattern patternForAttr = Pattern.compile(regExForTagAttr);
        Matcher matcherForTag = patternForTag.matcher(str);
        StringBuffer sb = new StringBuffer();
        boolean result = matcherForTag.find();
        while (result) {
            StringBuffer sbReplace = new StringBuffer();
            Matcher matcherForAttr = patternForAttr.matcher(matcherForTag.group(1));
